...
## Wiederholung einiger Funktionen
...
```{r mat3, exercise=TRUE,  exercise.setup = "btw-prepare"}
...
```{r mat4, exercise=TRUE,  exercise.setup = "btw-prepare"}
...
Sie sind fertig mit dem Tutorial zu den Grundlagen. Im nächsten Schritt werden wir sehen, wie man Daten in R einliest und wie man mit **Dataframes** arbeitet.
